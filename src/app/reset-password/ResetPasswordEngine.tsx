...
export default function ResetPasswordEngine() {
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Link href="/login"><div className="text-2xl font-black text-gray-900 mb-1">MyCET<span className="text-red-600">Reviewer</span></div></Link>
        ...
        {done ? (
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
            ...
            <Link href="/login" className="inline-block bg-red-600 hover:bg-red-700 text-white font-black px-6 py-3 rounded-xl transition-colors text-sm">Sign in →</Link>
          </div>
        ) : (
